...
title: "MCP and the SDK/ACP Automation Layer"
summary: "Two directions of external connection: dsh-mcp-client pulls third-party MCP tools onto ctx.tools, while dsh-sdk-protocol/client/server and dsh-acp let another process drive a harness agent as its own client"
module: ops
order: 19
sources:
