...
summary: "How SystemPrompt.assemble() turns scattered plugin fragments into one deterministic model request, and how ToolRuntime.execute() turns each resulting tool call into a validated, policed, observable execution"
module: foundations
order: 6
sources:
